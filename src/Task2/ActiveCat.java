...
public final class ActiveCat {
    ...
    private static final List<String> names = List.of("Peach", "Ginger", "Toby", "Seth", "Tibbles",
            "Tabby", "Poppy", "Millie", "Daisy", "Jasper", "Misty", "Minka");
    ...
    public void doAction() {
        System.out.printf("I %s!. %s%n", name, action.perform());
    }
